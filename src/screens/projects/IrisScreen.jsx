...
export default function IrisScreen(props) {
    return(
        <div className={styles.container}>
            ...
            I built Iris, my first major "side project", in November 2019 alongside two of my best friends, Shalin Shah (EECS Cal '21, currently SWE at Matician) and Sam Gorman (CS/Design Stanford '21). My main technical roles concerned data and backend engineering, along with major product and design decisions.<br/><br/>
            Iris was meant to be a "personal internet." While products like Google Home and Alexa serve you generalized information (i.e. results that someone else created for their own use cases), we believed that as humans our lives are largely controlled by in-the-moment, highly context-specific decisions. Our goal was to create a product that could serve you highly contextualized information in real time that couldn't be found by a simple Google search.<br/><br/>
