...
export default function IrisScreen(props) {
    return(
        <div className={styles.container}>
            ...
            I built Iris, my first company, in November 2019 alongside two of my best friends, Shalin Shah (EECS Cal '21, currently SWE at Matician) and Sam Gorman (CS/Design Stanford '21, currently pursuing an MS at Stanford). My main technical roles concerned data and backend engineering, along with major product and design decisions.<br/><br/>
