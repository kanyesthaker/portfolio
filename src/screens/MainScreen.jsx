...
export default function MainScreen(props) {
    return(
        <div className={styles.container}>
            ...
            <p><b>Currently reading</b>: <em>That Will Never Work</em> by Marc Randolph, <em>Cool Gray City of Love</em> by Gary Kamiya, <em>Thinking in Bets</em> by Annie Duke.</p>
            <p className={styles.textBlock}>
                Contact:<br/>
